...
Docker image that OpenPOIService is using to store data. This image is highly inspired by [kartoza/docker-postgis](https://github.com/kartoza/docker-postgis). 
